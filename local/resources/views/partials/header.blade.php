            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="primaryNav">
                    ...
                    <div class="field form-group fields-search-field" id="fields-search-field">
                        <div class="input ltr">
                            <input class="text form-control nicetext fullwidth" type="text" id="fields-email" name="fields[email]" value="" data-show-chars-left="" autocomplete="off" placeholder="Search ...">
                        </div>
