...
@section('content')
    <section id="page" class="gray-block">
        ...
        <div class="blue-block white-font">
            <div class="text-center">
                <h2>Experience information</h2>
            </div>
        </div>
        <div class="white-block">
            <div class="container-fluid profile experience-block" id='experience-info'>
                <div class="row">
                    <div class="col-xs-12">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="exp-padding">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    @if($experience->pricing->guests > 1){{ 1 }}
                                    - @endif{{ $experience->pricing->guests }}
                                    person(s)
                                </div>
                            </div>
                            <div class="row">
        ...
        <div class="gray-block">
            <div class="container-fluid" id='experience-info'>
                <div class="row">
                    <div class="col-xs-12">
                       <div class="map-block" style="margin-left: -30px; margin-right: -15px;">
        ...
        <div class="gray-block">
            ...
            <!-- Modal -->
                <div class="modal fade" id="review-modal" tabindex="-1" role="dialog"
                     aria-labelledby="review-modalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                ...
                                <div class='row'>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group" id="error-is_recommended">
                                            <label class="control-label" for="inputError1">Would you recommend this
                                                product
                                                to a friend?</label>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 col-xs-4">
                                                    <div class="row">
                                                        <label class="checkbox-inline">
                                                            <input id="is_recommended_no" name="is_recommended"
                                                                   type="radio"
                                                                   value="0">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group" id="error-title">
                                            <label class="control-label" for="inputError1">Title of your
                                                review</label>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group" id="error-nickname">
                                            <label class="control-label" for="inputError1">What's your
                                                nickname?</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="submit-review" class="btn btn-default">Submit your review
                                </button>
                            </div>
                        </div>
                    </div>
