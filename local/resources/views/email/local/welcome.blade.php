...
@section('content')
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        @include('email.partials.content', ['text' => "Please proceed to create your new experience/s on your local dashboard. You’ll by contacted by us to verify your profile, have a copy of your ID ready for part of the verification process. If you’re offering a food experience, get ready to cook for us, this is part of the verification process."])
