...
@section('content')
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        @include('email.partials.content', ['text' => "Date: " . $booking->experience->teaser])
        @include('email.partials.content', ['text' => "Time: " . $booking->experience->teaser])
        @include('email.partials.content', ['text' => "Number of guests: " . $booking->experience->teaser])
        @include('email.partials.content', ['text' => "Special request: " . $booking->experience->teaser])
        @include('email.partials.content', ['text' => "If there’s anything you’d like to add, please contact (Host name):"])
        @include('email.partials.button', ['url' => '/job/meta/create', 'text' => 'Link to go to host profile'])
