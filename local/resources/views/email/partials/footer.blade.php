    ...
    <tr>
        <td align="left" style="padding-top:20px">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                <tbody>
                <tr>
                    <td style="color:#a7a9ab;font-size:14px;line-height:16px;text-align: center;">
                ...
                <tr>
                    <td style="color:#a7a9ab;font-size:14px;line-height:16px;padding-top:20px;text-align: center;">
                ...
                <tr>
                    <td style="color:#a7a9ab;font-size:14px;line-height:16px;padding-bottom:20px;text-align: center;">
                        <span>© {{ date('Y') }} </span>
