            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    <td style="color:#a7a9ab;font-size:11px;line-height:13px;padding-top:20px;text-align: center;">
                        <a href="{{ url('/pages/privacy-policy') }}" style="color:#3D3D3D;text-decoration:none"
                           target="_blank">Privacy&nbsp;</a>|
                        <a href="{{ url('/pages/terms-conditions') }}" style="color:#3D3D3D;text-decoration:none"
                           target="_blank">&nbsp;Terms of Use&nbsp;</a>|
                        <a href="{{ url('/local/contact-us/create') }}" style="color:#3D3D3D;text-decoration:none"
