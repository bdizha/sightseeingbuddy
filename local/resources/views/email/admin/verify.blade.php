...
@section('content')
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        @include('email.partials.content', ['text' => "A new buddy has signed up. Please proceed to verify their profile here:"])
        @include('email.partials.content', ['text' => "Buddy's details:"])
