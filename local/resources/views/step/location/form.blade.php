                    ...
                    <div class="row form-group {{ $errors->has('country_id') ? 'has-error' : '' }}" >
                        <div class="col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                {{ Form::select('country_id', \App\Country::getList(), $location->country_id, ['class' => 'form-control fullwidth','required' => true, 'placeholder' => 'Your country*']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row form-group {{ $errors->has('city_id') ? 'has-error' : '' }}">
                        <div class="col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                {{ Form::select('city_id', \App\City::getList(), $location->city_id, ['class' => 'form-control fullwidth','required' => true, 'placeholder' => 'Your city or town*']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row form-group {{ $errors->has('street_address') ? 'has-error' : '' }}">
                        <div class="col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                {{ Form::text('street_address', $location->street_address, ['class' => 'form-control fullwidth','required' => true, 'placeholder' => 'Your street address*']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row form-group {{ $errors->has('postal_code') ? 'has-error' : '' }}">
                        <div class="col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                {{ Form::text('postal_code', $location->postal_code, ['class' => 'form-control fullwidth','required' => true, 'placeholder' => 'Your postal code*']) }}
                            </div>
                        </div>
                    </div>
