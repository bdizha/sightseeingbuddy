            ...
            <div class='row'>
                ...
                <div class="col-sm-5 col-xs-12">
                    <div class="form-group" id="destination"> 
                        ...
                        <input class="text form-control input-lg fullwidth" type="text" id="destination" name="destination" value="{{ $destination }}" placeholder="Your destination">
                    </div>
                    ...
                    <div class="form-group" id="duration"> 
                        <div class="input-group-addon"></div>
                        <input class="text form-control input-lg fullwidth datetime-input" type="text" id="duration" name="duration" value="{{ $dateFrom }} - {{ $dateTo }}" placeholder="Length of stay">
                    </div>
