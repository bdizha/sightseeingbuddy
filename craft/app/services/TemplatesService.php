...
class TemplatesService extends BaseApplicationComponent
{
	...
	private function _getCpElementHtml(&$context)
	{
		...
		$html .= '" data-id="'.$context['element']->id.'" data-buddye="'.$context['element']->locale.'" data-status="'.$context['element']->getStatus().'" data-label="'.$label.'" data-url="'.$context['element']->getUrl().'"';
